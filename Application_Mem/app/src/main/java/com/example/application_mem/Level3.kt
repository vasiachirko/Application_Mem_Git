...
class Level3 : Activity(), View.OnClickListener {
    ...
    override fun onClick(p0: View) {
        ...
        if (count_clicks < 3) {
            if (p0.id == R.id.btn1) {
                ...
                img_str_resourse = R.drawable.pic12
                ...
                img_str_resourse = R.drawable.pic13

            } else if (p0.id == R.id.btn15) {
                img_str_resourse = R.drawable.pic9

            } else if (p0.id == R.id.btn16) {
                img_str_resourse = R.drawable.pic15
                ...
                img_str_resourse = R.drawable.pic11

            } else if (p0.id == R.id.btn20) {
                img_str_resourse = R.drawable.pic10

            }  else if (p0.id == R.id.btn21) {
                img_str_resourse = R.drawable.pic7

            } else if (p0.id == R.id.btn22) {
                img_str_resourse = R.drawable.pic13

            } else if (p0.id == R.id.btn23) {
                img_str_resourse = R.drawable.pic4

            } else if (p0.id == R.id.btn24) {
                img_str_resourse = R.drawable.pic14

            } else if (p0.id == R.id.btn25) {
                img_str_resourse = R.drawable.pic3

            } else if (p0.id == R.id.btn26) {
                img_str_resourse = R.drawable.pic11

            } else if (p0.id == R.id.btn27) {
                img_str_resourse = R.drawable.pic3

            } else if (p0.id == R.id.btn28) {
                img_str_resourse = R.drawable.pic6

            } else if (p0.id == R.id.btn29) {
                img_str_resourse = R.drawable.pic14

            } else if (p0.id == R.id.btn30) {
                img_str_resourse = R.drawable.pic15
        ...
        if (!pictures_initialize){
            ...
            var btn_init_21 :ImageButton = findViewById(R.id.btn21)
            btn_init_21.setImageResource(R.drawable.tshirt)

            var btn_init_22 :ImageButton = findViewById(R.id.btn22)
            btn_init_22.setImageResource(R.drawable.tshirt)

            var btn_init_23 :ImageButton = findViewById(R.id.btn23)
            btn_init_23.setImageResource(R.drawable.tshirt)

            var btn_init_24 :ImageButton = findViewById(R.id.btn24)
            btn_init_24.setImageResource(R.drawable.tshirt)

            var btn_init_25 :ImageButton = findViewById(R.id.btn25)
            btn_init_25.setImageResource(R.drawable.tshirt)

            var btn_init_26 :ImageButton = findViewById(R.id.btn26)
            btn_init_26.setImageResource(R.drawable.tshirt)

            var btn_init_27 :ImageButton = findViewById(R.id.btn27)
            btn_init_27.setImageResource(R.drawable.tshirt)

            var btn_init_28 :ImageButton = findViewById(R.id.btn28)
            btn_init_28.setImageResource(R.drawable.tshirt)

            var btn_init_29 :ImageButton = findViewById(R.id.btn29)
            btn_init_29.setImageResource(R.drawable.tshirt)

            var btn_init_30 :ImageButton = findViewById(R.id.btn30)
            btn_init_30.setImageResource(R.drawable.tshirt)
    ...
    override fun onStart() {
        ...
        var my_btn21 :ImageButton = findViewById(R.id.btn21)
        my_btn21.setOnClickListener(this)

        var my_btn22 :ImageButton = findViewById(R.id.btn22)
        my_btn22.setOnClickListener(this)

        var my_btn23 :ImageButton = findViewById(R.id.btn23)
        my_btn23.setOnClickListener(this)

        var my_btn24 :ImageButton = findViewById(R.id.btn24)
        my_btn24.setOnClickListener(this)

        var my_btn25 :ImageButton = findViewById(R.id.btn25)
        my_btn25.setOnClickListener(this)

        var my_btn26 :ImageButton = findViewById(R.id.btn26)
        my_btn26.setOnClickListener(this)

        var my_btn27 :ImageButton = findViewById(R.id.btn27)
        my_btn27.setOnClickListener(this)

        var my_btn28 :ImageButton = findViewById(R.id.btn28)
        my_btn28.setOnClickListener(this)

        var my_btn29 :ImageButton = findViewById(R.id.btn29)
        my_btn29.setOnClickListener(this)

        var my_btn30 :ImageButton = findViewById(R.id.btn30)
        my_btn30.setOnClickListener(this)
